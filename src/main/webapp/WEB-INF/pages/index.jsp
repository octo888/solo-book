<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="row" id="features">
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Классика</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/classic.jpg" alt="Classic">
				...
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Современная проза</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/modern.jpg" alt="Modern">
				...
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Украинская проза</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/ukr.jpg" alt="Ukr">
				...
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Любовь</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/love.jpg" alt="Love">
				...
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Фантастика</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/fantastic.jpg" alt="Fantastic">
				...
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Детектив</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/detectiv.jpg" alt="Detective">
				...
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Бизнес</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/business.jpg" alt="Business">
				...
				<div class="col-sm-3 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Психология</h3>
						</div> <!-- end panel-heading -->

						<img src="resources/images/features/psycho.jpg" alt="Psycho">
					...
					<div class="tabbable">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								<h4><span class="glyphicon glyphicon-map-marker"></span>Читай-город <small>в первом Дрим-Тауне</small></h4>

								<iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d4249.257029723502!2d30.501406958876927!3d50.50887620150562!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1z0LTRgNC40Lwg0YLQsNGD0L0!5e1!3m2!1sru!2sua!4v1421352512391" width="100%" height="300" frameborder="0" style="border:0"></iframe>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<p><small class="text-muted">This form doesnt do anything</small></p>
